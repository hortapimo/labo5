...
name = "barridoFinal_615nm"
df=pd.read_csv(f"{name}_5V.txt")
df2=pd.read_csv(f"{name}_4V.txt")
df3=pd.read_csv(f"{name}_3V.txt")
df4=pd.read_csv(f"{name}_2V.txt")
...
fig.tight_layout()
fig.savefig("540nm_variosVoltajes.png")
fig.show()
#%%
